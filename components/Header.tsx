          ...
          <Link href="/">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold tracking-tight">
                <span
                  className={`transition-colors duration-300 ${isScrolled ? "text-primary" : "text-white"}`}
                >
                  Harmony
                </span>
                <span
                  className={`transition-colors duration-300 ${isScrolled ? "text-accent" : "text-accent"}`}
                >
                  Hub
                </span>
              </span>
